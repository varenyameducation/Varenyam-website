  ...
  return (
    <section className="relative isolate grain overflow-hidden bg-ink">
      ...
      <Image
        ...
        priority
        sizes="100vw"
        className="object-cover object-[57%_20%] lg:object-center"
      />
      ...
      />
      <div className="container-x relative z-10 hidden min-h-[620px] flex-col justify-center pb-36 pt-28 lg:flex lg:h-screen lg:max-h-[900px]">
        ...
        <div className="absolute right-8 top-1/2 hidden w-[290px] -translate-y-1/2 flex-col gap-3 xl:flex">
        ...
        {/* bottom bar — anchored within the viewport-height hero */}
        <div className="absolute inset-x-0 bottom-8 z-10 px-5 lg:px-8">
