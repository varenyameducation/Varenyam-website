export function PageHero({
  ...
  return (
    <section className="relative isolate grain overflow-hidden bg-navy text-white">
      ...
      <div className="container-x relative pb-14 pt-32 lg:pb-16 lg:pt-40">
